...
def experiment(variant):
    ...
    env = variant["trajectories"]
    trajectories = get_dataset(env)
    ...
    def get_batch(batch_size=43, max_len=K, traj_idx=0):

        s, a, r, d, rtg, timesteps, mask, si = [], [], [], [], [], [], [], 0
...
if __name__ == "__main__":
    ...
    parser.add_argument("--batch_size", type=int, default=39)
    ...
    parser.add_argument("--num_steps_per_iter", type=int, default=165 * 2)
    parser.add_argument("--device", type=str, default="cuda:0")
    parser.add_argument("--trajectories", type=str, default="create_data/results_lin/")
